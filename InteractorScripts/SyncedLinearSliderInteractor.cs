...
{
    public class SyncedLinearSliderInteractor : SingleSyncedFloatInteractor
    {
        ...
        public override void InteractionStart(Vector3 rayWorldOrigin, Vector3 rayWorldDirection)
        {
            ...
            {
                defaultUnityOffset = CurrentSyncedUnityValue; //ToDo: Find better solution. Fail if needed. This will jump and introduce weird offset.
            }
            else
            {
                defaultUnityOffset = unityOffset - CurrentSyncedUnityValue;
            }
        }
        ...
        public override void UpdateElement(Vector3 rayWorldOrigin, Vector3 rayWorldDirection)
        {
            ...
            {
                CurrentSyncedUnityValue = rawUnityValue - defaultUnityOffset;
            }
        }

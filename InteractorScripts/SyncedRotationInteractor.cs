...
{
    public class SyncedRotationInteractor : SingleSyncedFloatInteractor
    {
        ...
        public override void InteractionStart(Vector3 rayWorldOrigin, Vector3 rayWorldDirection)
        {
            ...
            {
                defaultAngleRadOffset = CurrentSyncedUnityValue; //ToDo: Find better solution. Fail if needed. This will jump and introduce weird offset.
            }
            else
            {
                defaultAngleRadOffset = unityOffsetRad - CurrentSyncedUnityValue;
            }
        }
        ...
        public override void UpdateElement(Vector3 rayWorldOrigin, Vector3 rayWorldDirection)
        {
            ...
            {
                CurrentSyncedUnityValue = rawUnityValue - defaultAngleRadOffset;
            }
        }
